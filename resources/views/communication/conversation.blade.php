                                ...
                                @forelse($conversations as $conversation)
                                  @if(Auth::user()->id==$conversation->sender_id)
                                      ...
                                      <li class="right clearfix"><span class="chat-img pull-right">
                                          <img width=50 height=50 src="/img-uploads/nuj.jpg" alt="User Avatar" class="img-circle" />
                                      </span>
                                          <div class="chat-body clearfix">
                                              <div class="header">
                                                  <small class=" text-muted"><span class="glyphicon glyphicon-time"></span>{{ $conversation->created_at }}</small>
                                          ...
                                          <div class="chat-body clearfix">
                                              <div class="header">
                                                  <strong class="primary-font">{{ Auth::user()->getSender($conversation->sender_id)->fname }}</strong> <small class="pull-right text-muted">
                                                      <span class="glyphicon glyphicon-time"></span>{{ $conversation->created_at }}</small>
                                              </div>
                                              <p>
                                                  {{ $conversation->content }}
                                              </p>
