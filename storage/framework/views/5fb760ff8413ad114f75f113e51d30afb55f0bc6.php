                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/login')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('username') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="string" class="form-control" name="username" value="<?php echo e(old('username')); ?>" required autofocus>
                        ...
                        <div class="form-group">
                            <div class="col-md-8 col-md-offset-4">
                                ...
                                <p class="links">Don't have an account? <a href="<?php echo e(url('/register')); ?>">Sign Up</a></p>
                            </div>
                        </div>
                    </form>
                </div>
